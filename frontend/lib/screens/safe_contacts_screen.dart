                      ...
                      : ListView.separated(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return Dismissible(
                              ...
                              onDismissed: (_) => appState.removeEmergencyContact(item.id),
                              child: Container(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    IconButton(
                                      ...
                                      onPressed: () => appState.setPrimaryEmergencyContact(item.id),
                                      icon: Icon(
                                        item.isPrimary ? Icons.star_rounded : Icons.star_border_rounded,
                                        color: item.isPrimary ? const Color(0xFFFFD54F) : Colors.white70,
                                      ),
                                    ),
                                    IconButton(
                                      onPressed: () => appState.removeEmergencyContact(item.id),
                                      icon: const Icon(
