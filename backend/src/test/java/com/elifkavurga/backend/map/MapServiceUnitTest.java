...
class MapServiceUnitTest {
    ...
    void setup() {
        ...
        service = new MapServiceImpl(repo, null, fixedClock); // entityManager not used here
    }
    ...
    void computeRiskDeterministic() {
        ...
        // based on our manual calculation score should be around 4.25*10=42.5 -> medium
        assertThat(first.getLevel()).isEqualTo("medium");
        assertThat(first.getScore()).isBetween(40.0, 45.0);
    }
}